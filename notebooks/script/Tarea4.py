...
# <div style="text-align: justify;">
# Determinación de los factores que contribuyen principalmente al diagnóstico de diabetes:
# 
#    - En el análisis de los datos, las variables más influyentes fueron GenHlth (estado general de salud) y HighBP (presión arterial alta). Estas variables fueron destacadas por su frecuencia e impacto en los modelos predictivos, sugiriendo que la autoevaluación de la salud general y la hipertensión son factores clave en la predicción de la diabetes.
# 
# Aplicación de modelos de aprendizaje automático:
# 
# - Se implementaron modelos de clasificación supervisados como la Regresión Logística y Random Forest, pero enfrentaron dificultades debido a un desbalance en las clases (False y True). Este desbalance afectó el rendimiento de los modelos, generando un sesgo hacia la clase mayoritaria, lo que limitó su capacidad para predecir correctamente los casos positivos de diabetes.
# 
# Comparación del rendimiento de los modelos y recomendaciones:
# 
# - A pesar de los ajustes, las métricas de evaluación mostraron que los modelos no lograron un desempeño equilibrado. Para abordar este problema, se recomienda aplicar técnicas de balanceo de clases como el SMOTE (Synthetic Minority Over-sampling Technique) para equilibrar las clases y mejorar la clasificación.
#     También se sugiere realizar una optimización de hiperparámetros utilizando Grid Search o Random Search, lo que permitirá mejorar el ajuste del modelo y aumentar la precisión en la predicción del diagnóstico de diabetes.
# </div>
# 
# 
# 
